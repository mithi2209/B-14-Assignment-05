...
const AllTechCards = ({ techData , selectedStacks , setSelectedStacks}:techDataProps) => {

    // const [isAddToStack, setIsAddToStack] = useState<TechsDataType[]>([]);
  
  const handleAddedStack = (techData:TechsDataType) =>{

    setSelectedStacks((prev) => [...prev, techData]);
